const en = {
  ...
  "plans.featurePlaceholder": "e.g. api_calls",
  "plans.valuePlaceholder": "e.g. true, 100",
  "plans.selectPeriod": "Select period",
  "plans.quotaUnitPlaceholder": "e.g. requests, tokens",
  "plans.meterEventPlaceholder": "api_calls (configured in Stripe dashboard)",

  // Releases
  "releases.title": "Releases",
  "releases.subtitle": "Distribute software updates to customers through Sparkle, Velopack, or Tauri.",
  ...
  "releases.noEligibleProductsDesc":
    "Release feeds are available for desktop and hybrid products only. Change an existing product type or create a desktop/hybrid product.",
  ...
  "releases.deletePermanently": "Delete permanently",
  "releases.deleteAfterYank": "Delete (yank first)",
  "releases.publishedToast": "Release published.",
  "releases.unyankedToast": "Release restored.",
  "releases.yankedToast": "Release yanked.",
  "releases.deletedToast": "Release permanently deleted.",
  "releases.unyankTitle": "Restore {version}?",
  "releases.unyankDesc":
    "This restores the release to its public update feed. Clients on that channel can receive {version} again.",
  "releases.deleteDraftTitle": "Delete draft release?",
  "releases.deleteDraftDesc": "Permanently removes the draft and all uploaded artifacts.",
  "releases.deleteYankedTitle": "Permanently delete yanked release?",
  "releases.deleteYankedDesc":
    "This permanently removes {version}, its release notes, and every uploaded artifact. It cannot be restored.",
  "releases.deleteConfirmationLabel": "Enter {version} to confirm",
  "releases.publishOlderTitle": "Publish a version below the current latest?",
  "releases.publishOlderDesc":
    "{version} is older than {latest}. Velopack and Tauri reject downgrades by default, and Sparkle is not SemVer-aware. Continue only for an intentional backport.",
  "releases.publishAnyway": "Publish anyway",
  "releases.createDesc": "Create the release record, then add platform-specific binaries in the next step.",
  "releases.displayName": "Display name (optional)",
  "releases.displayNamePlaceholder": "e.g. MyApp Pro",
  "releases.notes": "Release notes (optional, Markdown)",
  "releases.notesPlaceholder": "What changed in this version?",
  "releases.creating": "Creating...",
  "releases.createDraft": "Create draft",
  "releases.createdToast": "Draft {version} created. Add artifacts before publishing.",
  "releases.draftDetailDesc": "Add platform binaries below, then publish when every artifact is ready.",
  "releases.lockedDetailDesc": "This release is {status}. Its artifacts cannot be changed.",
  "releases.artifacts": "Artifacts ({count})",
  "releases.noArtifacts": "No artifacts yet. Add at least one platform before publishing.",
  "releases.addArtifactRemaining": "Add artifact ({count} platform(s) remaining)",
  "releases.notUploaded": "Not uploaded yet",
  "releases.ready": "Ready",
  "releases.pending": "Pending",
  "releases.platformFileRequired": "Platform and file are required.",
  "releases.uploadFailed": "Upload failed: {status}",
  "releases.artifactUploaded": "Artifact for {platform} uploaded.",
  "releases.addArtifact": "Add artifact",
  "releases.addArtifactDesc":
    "Upload a platform binary for {version}. The file goes directly to storage and is finalized for signing on publish.",
  "releases.artifactFile": "Artifact file",
  "releases.reservingArtifact": "Reserving artifact slot...",
  "releases.uploadingArtifact": "Uploading to storage...",
  "releases.finalizingArtifact": "Computing SHA-256 and finalizing...",
  "releases.working": "Working...",
  "releases.upload": "Upload",
  "releases.yankTitle": "Yank {version}?",
  "releases.yankDesc":
    "Yanking removes the release and all its artifacts from update feeds. Existing installations keep working. The reason is recorded in the audit log.",
  "releases.reason": "Reason",
  "releases.yankReasonPlaceholder": "Describe the problem and any rollback recommendation.",
  "releases.signingKeysTitle": "Release signing keys",
  "releases.signingKeysDesc":
    "Generate one Ed25519 keypair per product. Embed the public key in the client; the server signs artifacts on publish.",
  "releases.signingKeyGenerated": "Signing key generated.",
  "releases.noActiveSigningKey": "No active signing key",
  "releases.noActiveSigningKeyDesc": "Releases remain unsigned until a signing key is generated.",
  "releases.generating": "Generating...",
  "releases.generateSigningKey": "Generate signing key",
  ...
  "releases.publicKeyDesc": "Embed this public key in the client update verifier.",
  "releases.downloadPem": "Download .pem",
  "releases.rotate": "Rotate",
  "releases.deactivate": "Deactivate",
  "releases.signingKeyRotated": "Signing key rotated.",
  "releases.rotateTitle": "Rotate signing key?",
  "releases.rotateDesc":
    "A new keypair will be generated and the old key retained as inactive. Clients containing only the old public key cannot verify new releases.",
  "releases.reasonAudit": "Reason (audit log)",
  "releases.rotatePlaceholder": "Routine rotation; no key compromise.",
  "releases.rotating": "Rotating...",
  "releases.signingKeyDeactivated": "Signing key deactivated.",
  "releases.deactivateTitle": "Deactivate signing key?",
  "releases.deactivateDesc":
    "Future releases will be unsigned until a new key is generated. Clients enforcing signatures will reject them.",
  "releases.deactivatePlaceholder": "Why are you deactivating this key?",
  ...
  "licenses.revealKey": "Reveal license key",
  ...
  "licenses.validUntilSubscriptionHint": "Leave empty for one plan period, or choose a custom first period end.",
  "licenses.validUntilEdit": "Edit expiry",
  "licenses.validUntilClear": "Leave empty to make the license perpetual.",
  "licenses.validUntilSubscriptionRequired": "Subscription licenses must keep an expiry date.",
  ...
  "licenses.role": "Role",
  "licenses.roleMember": "Member",
  "licenses.roleAdmin": "Administrator",
  ...
  "apiKeys.namePlaceholder": "e.g. CI provisioning or production backend",
  ...
  "customers.eyebrow": "Business records",
  "customers.new": "New customer",
  "customers.edit": "Edit customer",
  "customers.saved": "Customer saved.",
  "customers.search": "Search name, email, company, or external ID",
  "customers.kind": "Customer type",
  "customers.allKinds": "All types",
  ...
  "customers.externalId": "External customer ID",
  "customers.stripeId": "Stripe customer ID",
  "customers.notes": "Notes",
  "customers.formDesc":
    "Customer records are independent from sign-in accounts. Changing the primary email does not update existing license delivery addresses.",
  "customers.noPhone": "No phone number",
  "customers.archive": "Archive",
  "customers.restore": "Restore",
  "customers.issueLicense": "Issue license",
  "customers.quickNew": "Quick-add customer",
  "customers.selectCustomer": "Select a customer",
  "customers.allCustomers": "All customers",
  "customers.unassigned": "Unassigned customer",
  "customers.licenseEmailIndependent":
    "Customer ownership and license delivery email are independent; reassigning does not change the recipient.",

  "users.title": "Users",
  "users.subtitle": "{count} sign-in accounts.",
  ...
  "users.licenses": "Licenses",
  "users.subscriptions": "Subscriptions",
  "users.activity": "Activity",
  "users.totalUsage": "Total usage",
  "users.activeSeats": "Active seats",
  "users.noLicenses": "No licenses found.",
  "users.noSubscriptions": "No subscriptions found.",
  "users.noRecentActivity": "No recent activity.",
  "users.provider": "Provider",
  "users.periodRange": "Period",
  "users.cancelAtEnd": "Cancel at end",
  ...
  "settings.customLogoAlt": "Custom logo",
  ...
  "emailTemplates.licenseCreated": "License created",
  "emailTemplates.licenseExpiring": "License expiring",
  "emailTemplates.licenseExpired": "License expired",
  "emailTemplates.trialExpired": "Trial expired",
  "emailTemplates.licenseSuspended": "License suspended",
  "emailTemplates.quotaWarning": "Quota warning",
  "emailTemplates.seatInvite": "Seat invitation",
  "emailTemplates.paymentFailed": "Payment failed",
  "emailTemplates.customized": "Customized",
  "emailTemplates.previewTitle": "Email preview",
